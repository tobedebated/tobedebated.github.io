Modernizr.addTest("retina", function() {
    ...
    o.prototype.generateUUID = function() {
        ...
        for (e = g.length - 1; e >= 0; e--) g[e].el == t && (g[e].destroy(), g.splice(e, 1));
        ...
        i.prototype = {
            ...
            mouseWheelProceed: function(t) {
                ...
                "vertical" == this.options.tp) {
                    e = t + this.options.$container.scrollTop();
    ...
    t.constants = _.extend({
        ...
        getCurrentTranslate: function(t) {
            ...
            var s = i.split("(")[1];
            return [ (s = (s = s.split(")")[0]).split(","))[4] - 0, s[5] - 0 ];
        },
        ...
        waitForTransitionEnd: function(t, e, i, s) {
            ...
            }[Modernizr.prefixed("transition")], a = function(e) {
                if (e) {
                    var r = e.originalEvent.propertyName.toLowerCase();
                    if (!$(e.target).is(t)) return;
                    if (-1 == r.indexOf(i)) return;
                }
                t.off(n, a), clearTimeout(o), s();
            };
            t.on(n, a);
        ...
        deepExtend: function(t) {
            ...
            return _.each(Array.prototype.slice.call(arguments, 1), function(n) {
                e = n, Object.keys(e).forEach(function(n) {
                    var a = t[n], o = e[n];
                    !function(t, e) {
    ...
    if (jQuery.fn.selectText = function() {
        ...
        return this.addClass(t), clearTimeout(this.data("timeout")), i = setTimeout(function() {
            "object" == typeof s && s.length && (s.removeClass(t), s.data("timeout", null));
    ...
    t.mathutils = {
        ...
        calcRotatedBox: function(t) {
            ...
            return _.each(i, function(l, c) {
                var d = t.left + t.width * i[c], h = t.top + t.height * s[c], u = d - n, p = a - h, d = n + r * u + o * p, h = a + o * u - r * p;
                e.push({
                    x: d,
                    y: h
                });
    ...
    t.textutils = {
        ...
        generateCSS: function(t, e, i, s, n) {
            if (s) {
                var a = this.STYLE_PREFIXES[t][e], n = n || {}, o = this, r = "";
                _.each(s, function(e) {
        ...
        appendFontsCssToDocument: function(e, i) {
            ...
            _.each(r, function(n, a) {
                var o, r, l, c, h, u = "custom" == a ? 1 : "google" == a ? 22 : n.length, p = Math.ceil(n.length / u), g = 0;
                for (o = 0; o < p; o++) {
                    if (r = o * u, l = Math.min((o + 1) * u, n.length), c = n.slice(r, l), h = _.pluck(c, "data"), fontsAndVariations = _.pluck(c, "fontAndVariations"), 
                    $("link, style").addClass("existing"), "google" == a) {
                        s((m = (t.constants.IS_FILE_PROTOCOL ? "http://" : "//") + "fonts.googleapis.com/css?family=") + h.join("%7C") + "&subset=latin,vietnamese,khmer,cyrillic-ext,greek-ext,greek,devanagari,latin-ext,cyrillic");
                    }
                    if ("typekit" == a && !Modernizr.isboxversion) {
                    ...
                    if ("webtype" == a) {
                        m = t.common.isDownloadedSource ? t.constants.readymag_host : "";
                        if (!$('link.fonts[data-provider="webtype"]').length) {
                            s(m + (f = window.ServerData && window.ServerData.fonts && window.ServerData.fonts.webtype));
                        }
                    }
                    if ("typetoday" == a && !d) {
                        var m = t.common.isDownloadedSource ? t.constants.readymag_host : "";
                        if (!$('link.fonts[data-provider="typetoday"]').length) {
                            var f = window.ServerData && window.ServerData.fonts && window.ServerData.fonts.typetoday;
                            s(m + f);
                        }
                    }
                    if ("custom" == a) {
                        var v = h[0].signed_css_url || h[0].css_url;
                        /^\/api\/fonts\//i.test(v) ? function() {
                            var t = $("<style>").attr("type", "text/css");
                            $("head").append(t), $.get(v, function(e) {
                    ...
                    w($("link:not(.existing), style:not(.existing)")), $("link, style").removeClass("existing");
                }
            }), !h && _.isFunction(i) && i();
        },
        loadTypekitSubstitutionFonts: function(e) {
            e && e.length && _.each(e, function(e) {
                var i = e.data.id, s = (e.data.variations, _.findWhere(t.textutils.fontsShortList.typekit, {
                    id: i
                })), n = {
                    ...
                    serif: "georgia-pro",
                    monospaced: "nitti"
                }, a = "template-export-pdf-typekit-substitution-" + (n[(s = (s = s && s.browse_info) && s.classification) && s.length && s[0] || "sans-serif"] || n["sans-serif"]), o = (0, 
                t.templates[a])({
                    id: i
                });
                $("head").append(o);
        ...
        fontLoadedTimeoutCheck: function(t) {
            var i = Date.now(), s = function(n, a) {
                var o = Date.now() - i;
                document.fonts.check(t) ? n(t) : o < 3500 ? setTimeout(s.bind(null, n, a), e) : a(t);
            };
            return new window.Promise(function(t, e) {
                s(t, e);
            });
        },
    ...
    t.classes.extendAnalyticsPublic = {
        ...
        _parseDimensions: function(t) {
            return {
                magId: t.magId || e.dimension1,
                magCreatorId: t.magCreatorId || e.dimension2,
                pageType: t.pageType || e.dimension3,
                userId: t.userId || e.dimension4
            };
        },
...
"undefined" == typeof RM && (RM = {}), function(t) {
        ...
        initFacebookAPI: function(e) {
            ...
            if ("function" == typeof e) {
                ...
                window.fbAsyncInit = function() {
                    ...
                    var n, a = e.getElementsByTagName(i)[0];
                    e.getElementById(s) || ((n = e.createElement(i)).id = s, n.src = t.utils.selectProtocol("//connect.facebook.net/en_US/sdk.js"), 
    ...
    t.classes.embedplugins = t.classes.embedplugins || {}, t.embedutils = t.embedutils || {}, t.embedutils.findPlugin = function(e) {
        ...
        sanitize: function(t) {
            var e = $(t);
            if ("object" != typeof e || !e.length) return e;
            ...
            return _(s).each(function(t) {
                if ("object" == typeof t && t.specified && _.contains(n, t.name.toLowerCase())) {
    ...
    "use strict";
    var t = this, e = "undefined" != typeof require && "undefined" != typeof process, i = t._;
    if (void 0 === i) {
        if (!e || i) throw new Error("embed matcher requires underscore, see http://underscorejs.org");
    ...
    var s = {
        ...
        matchCode: function(t, e) {
            t = (t || "").trim();
            for (var s in this.matchers) {
                var n = this.matchers[s];
                if (i.isFunction(n)) return n(t, e) ? s : this.defaultType;
                for (var a in n) if (a = n[a], i.isFunction(a)) {
                    if (a(t, e)) return s;
                } else {
    ...
    "undefined" != typeof exports ? "undefined" != typeof module && module.exports && (exports = module.exports = s) : t.RM ? t.RM.embedMatcher = s : t.embedMatcher = s;
    ...
    t.animationutils = {
        ...
        ANIMATION_PROPERTIES: function() {
            ...
            if (void 0 != d.style.animationName) t = !0, i = i.toLowerCase(), s = s.toLowerCase(); else for (h = 0; h < l.length; h++) if (void 0 != d.style[l[h] + "AnimationName"]) {
                e = l[h] + "Animation", i = c[h] + i, s = c[h] + s, n = "-" + l[h].toLowerCase() + "-" + n, a = "@-" + l[h].toLowerCase() + "-keyframes", 
                t = !0;
                break;
            }
            if (void 0 == d.style.transform) for (var h = 0; h < l.length; h++) if (void 0 != d.style[l[h] + "Transform"]) {
        ...
        onSendButtonClick: function() {
            ...
            var i = {
                success: function(t) {
                    ...
                    this.$(".congrats-wrapper .subscription .caption").html("1 " + e.period.capitalize() + " of<br>Super Publisher"), 
    ...
    var t = this, e = "undefined" != typeof require && "undefined" != typeof process, i = t._;
    if (void 0 === i) {
        if (!e || i) throw new Error("shareutils requires underscore, see http://underscorejs.org");
        i = require("underscore");
    }
    var s = null;
    if (e) {
        var n = require("path").dirname(require.main.filename);
        s = require(n + "/tools.coffee");
    }
    var a = {
        defaultDescription: "Built with Readymag—a tool to design anything on the web.",
        maxTweetLen: 116,
        addOrigin: function(t, i) {
            return e ? s.addOrigin.apply(this, arguments) : t ? i && -1 == t.indexOf("://") ? i + t : t : "";
        },
        addFilenameComponent: function(t, i) {
            return e ? s.addFilenameComponent.apply(this, arguments) : RM.utils.addFilenameComponent.apply(this, arguments);
        },
        getPageScreenshot: function(t, i, s) {
            s = s || {};
            var n = e ? s.host : window.location.protocol + "//" + window.location.host, a = i && i.screenshot;
        ...
        getDefaultShare: function(t, e, s) {
            if (s = s || {}, i.isEmpty(e) || !i.isObject(e)) return {};
            var n = e.emptyTitle ? "" : e.title, o = "", r = e.description || (s.customDomain ? "" : a.defaultDescription), l = "";
            s.customDomain ? o = s.forProject ? n || "Project" : (n ? n + " — " : "") + (t.title || "Page " + t.num) : (s.forProject || (o = (t.title ? "‘" + t.title + "’" : "Page " + t.num) + " from "), 
            o += (n ? "‘" + n + "’" : "Project") + " by " + e.user.name, s.forProject && e.description && (o += " | Readymag")), 
            l = s.forProject ? a.getPageScreenshot(e, i.findWhere(e.pages, {
                num: 1
            }), s) : a.getPageScreenshot(e, t, s);
            var c = "";
            return s.customDomain ? s.forProject ? c = n ? a._formatTweet({
                ...
                prefix: "‘",
                val: n,
                suffix: "’ by " + e.user.name
            }) : "Project by " + e.user.name : n || t.title ? !n && t.title ? c = a._formatTweet({
                prefix: "‘",
                val: t.title,
                suffix: "’ from Project by " + e.user.name
            }) : n && !t.title ? c = a._formatTweet({
                ...
                suffix: "’ by " + e.user.name,
                minLength: 20
            })).length > a.maxTweetLen && (c = "‘" + t.title + "’ by " + e.user.name).length > a.maxTweetLen && (c = a._formatTweet({
                prefix: "‘",
                val: t.title,
                suffix: "’ by " + e.user.name
            })) : c = "Page " + t.num + " from Project by " + e.user.name, {
                image: l,
                title: o || "",
                description: r || "",
                tweet: c
        ...
        getFinalShare: function(t, e, s) {
            if (s = s || {}, i.isEmpty(e) || !i.isObject(e)) return {};
            var n = a.getDefaultShare(t, e, s), o = e.master_share_pid && i.find(e.pages, function(t) {
                return t._id.toString() == e.master_share_pid.toString();
            }), t = s.forProject ? i.findWhere(e.pages, {
                num: 1
            }) : t, r = o || t, l = r.custom_shares;
            return i.isEmpty(l) || (n.title = l.title || "", n.description = l.description || "", n.tweet = l.tweet || "", 
            l.image ? n.image = l.image : r.screenshot ? n.image = a.getPageScreenshot(e, r, s) : n.image = ""), 
            n;
        },
        getDefaultSEO: function(t, e, s) {
            if (s = s || {}, i.isEmpty(e) || !i.isObject(e)) return {};
            var n = e.emptyTitle ? "" : e.title, o = "", r = "";
            return s.customDomain ? t && t.num > 1 ? o = (n ? n + " — " : "") + (t.title || "Page " + t.num) : (o = n || "Project", 
            r = e.description || "") : (t && t.num > 1 ? o = (t.title ? "‘" + t.title + "’" : "Page " + t.num) + " from " : r = e.description || a.defaultDescription, 
            o += (n ? "‘" + n + "’" : "Project") + " by " + e.user.name + " | Readymag"), {
                title: o || "",
                description: r || "",
                keywords: ""
            };
        },
        getFinalSEO: function(t, e, s) {
            if (s = s || {}, i.isEmpty(e) || !i.isObject(e)) return {};
            var n = a.getDefaultSEO(t, e, s);
        ...
        share: function(t) {
            ...
            t.publishedVersion) {
                ...
                "email" == t.tp) {
                    var r = "mailto:", c = (l = "Check out " + encodeURIComponent(i.title)) + encodeURIComponent("\n\n") + e + (t.mag.is_private ? encodeURIComponent("\n") + "Password: " + t.mag.pass : "");
                    window.location.href = r + "?subject=" + l + "&body=" + c;
                }
                if ("report" == t.tp) {
                    var r = "mailto:" + RM.constants.SUPPORT_MAIL, l = "Report " + encodeURIComponent(e), c = encodeURIComponent("Please tell us why are you reporting this: ");
                    window.location.href = r + "?subject=" + l + "&body=" + c;
                }
            }
            if ("report" != t.tp) {
    ...
    "undefined" != typeof exports ? "undefined" != typeof module && module.exports && (exports = module.exports = a) : t.RM ? t.RM.shareutils = a : t.shareutils = a;
    ...
    t.classes.Page = Backbone.View.extend({
        ...
        loadWidgetsPack: function(t, e) {
            ...
            for (i = 0; i < t.length; i++) {
                var r = t[i];
                r.rendered || r.loaded || r.destroyed || (r.canRenderImmediately() || (s++, r.on("loaded destroyed", function() {
                    n++, o && s == n && e();
                }, r)), a++, r.render());
            }
            o = !0, a || e(), s == n && e();
        ...
        signalOnLoading: function() {
            ...
            var e = this.widgets.length, i = this;
            _.each(this.widgets, function(s) {
                s.on("loaded", function() {
                    "background" == this.type && i.destroyLQBackground({
                        animate: !0
                    }), e--, this.hasLoadAnimation() && (i._widgetsWithLoadAnimation--, i._widgetsWithLoadAnimation || (i.loadAnimationsReady = !0, 
                    i.trigger("loadAnimationsReady"))), e || (i.fireReadyTimeout = setTimeout(t, 200));
                }, s);
            ...
            }, this.BGWidget), 0 == e && (this.fireReadyTimeout = setTimeout(t, 200));
        },
    ...
    t.classes.Widget = Backbone.View.extend({
        ...
        calcDistsToPageVisibleBounds: function() {
            ...
            if (this.fixed_position) {
                ...
                var u = this.page.contentPosition.left / this.page.scale, p = this.page.contentPosition.top / this.page.scale, g = this.x + this.w / 2, m = this.y + this.h / 2, d = m + p, h = this.page.contentHeight - m + p;
                e = {
                    left: Math.max(0, g + u),
        ...
        checkLink: function() {
            ...
            if (this.clickLink) {
                ...
                if (s && (l = "mailchimp-link"), n && (l = "anchor-link"), a && (l = "share-link"), !e) {
                    ...
                    var d = this.page.mag.getPageNum(c), o = d && this.page.mag.getPageUri ? "/" + this.page.mag.getPageUri(c) : "javascript:void(0)";
        ...
        loadVisibleScreenshots: function() {
            if (this.mag.pages && this.mag.pages.length) {
                ...
                this.$(".page").each(function(i) {
                    var s = $(this), n = s.attr("data-src");
                    if (i >= t.min && i <= t.max && n && !e.loadedScreenshots[i]) {
                        (s = $(this)).find(".screenshot").prop("src", n), s.removeAttr("data-src"), e.loadedScreenshots[i] = !0;
                    }
                });
            }
        },
        unloadInvisibleScreenshots: function() {
            if (!this.shown) {
                ...
                this.$(".page").each(function(i) {
                    var s = $(this), n = s.attr("data-src");
                    if ((i < t.min || i > t.max) && !n && e.loadedScreenshots[i]) {
                        (s = $(this)).attr("data-src", s.find(".screenshot").prop("src")), s.find(".screenshot").prop("src", e.IMG_STUB), 
    ...
    t.classes.Mag = Backbone.View.extend({
        ...
        setViewerOptions: function(e) {
            ...
            "vertical" === i.viewertype && (Modernizr.isdesktop ? this.isStickyVerticalViewer = i.stickyviewer && !this.isPreview : (this.isStickyVerticalViewer = Modernizr.csspositionsticky, 
            ...
            i.endpage = i.endpage && !this.isPreview && !!this.published, i.slidein = i.slidein && !i.stickyviewer, 
        ...
        onPageVisibilityChange: function() {
            if (this.currentPage) if (t.utils.PageVisibilityManager.isPageHidden()) {
                ...
                var e = this.getPage(this.currentPage.num + 1);
        ...
        findPageOnCurrentMagScroll: function(t) {
            t = t || {};
            var e, i, s, n, a = this.getScroll(), o = this.getContainerSizeCached(), a = Math.min(Math.max(a, 0), this.magHeight - o.height), r = this.pages.length, l = a + (t.pageStartsOnBottom ? o.height - 50 - 16 - 16 : 0);
            for (e = 0; e < r; e++) {
        ...
        showPage: function(t, e) {
            ...
            if (!s) return this.router.onError(), !1;
        ...
        scheduleSetUrlString: function() {
            if (!Modernizr.chrome) return this.router.setUrlString(arguments), void (this._resetUrlStringTimeoutFunc = !1);
            this._resetUrlStringTimeoutFunc = function() {
                clearTimeout(this._urlStrigScheduleTimeout), this._urlStrigScheduleTimeout = setTimeout(function() {
                    this._resetUrlStringTimeoutFunc = null, this.router.setUrlString(arguments);
                }.bind(this), 100);
            ...
            if (_.isUndefined(s)) {
                ...
                _.each(this.aboveGlobalWidgets, function(s) {
                    ...
                    if (u || p || o) {
                        ...
                        s.updatePage(g), m ? t.globalwidgets.hide(s).then(function() {
    ...
    t.classes.ShapeSVG = function() {}, t.classes.ShapeSVG.prototype = {
        ...
        generateShapeSVG: function(t, e, i, s, n) {
            ...
            if ("rectangle" == n || "polygon" == n) {
                ...
                var g = "rectangle" == n ? 4 : e.get("sides"), p = e.get("borders"), m = e.get("radius") || 0, f = function(t, e, i, s) {
            ...
            if ("line" == n) {
                var p = e.get("weight"), u = Math.round(s / 2) + (p % 2 == 1 ? .5 : 0), w = "", y = [ 13 * p / 3, 2 * p / 3 ].join(" "), b = p > 1 ? [ .001, 5 * p / 3 ].join(" ") : [ 1, 2 ].join(" "), k = "dotted" == e.get("stroke") ? p / 2 : 0;
                if (w = "M" + k + " " + u + " L" + i + " " + u, "solid" == e.get("stroke") && (o = '<path d="' + w + '" style="fill:none; stroke:' + c + ";stroke-width:" + p + '"/>'), 
                "double" == e.get("stroke")) {
                    o = '<path d="' + ("M" + k + " " + (u - p) + " L" + i + " " + (u - p)) + '" style="fill:none; stroke:' + c + ";stroke-width:" + p + '"/>', 
                    o += '<path d="' + ("M" + k + " " + (u + p) + " L" + i + " " + (u + p)) + '" style="fill:none; stroke:' + c + ";stroke-width:" + p + '"/>';
                }
                "dotted" == e.get("stroke") && (o = '<path d="' + w + '" stroke-linecap="round" stroke-dasharray="' + b + '" style=" fill:none; stroke:' + c + ";stroke-width:" + p + '"/>'), 
                "dashed" == e.get("stroke") && (o = '<path d="' + w + '" stroke-dasharray="' + y + '" style=" fill:none; stroke:' + c + ";stroke-width:" + p + '"/>');
            }
            if ("icon" == n) {
                var x = this.iconData || this.current_icon_data;
                if (!x) return null;
                var P = x.$svg.clone();
                return P.css({
                    width: "100%",
                    height: "100%"
                }), c = this.getRGBA(l, 1), P.find("*:not(.fixed-color)").each(function() {
                    var t = $(this);
                    t.css({
                        fill: "",
                        "fill-opacity": ""
                    }), t.get(0).removeAttribute("fill"), t.get(0).removeAttribute("fill-opacity");
                }), P.get(0).setAttribute("fill", c), P.get(0).setAttribute("fill-opacity", e.get("bg_opacity")), P;
            }
    ...
    t.classes.SlideshowPlayer = Backbone.View.extend({
        ...
        moveToImage: function(t, i, s) {
            function n() {
                ...
                if (d.handleThumbnails && !d.initialRender) {
                    ...
                    var r = p.position().left, l = d.$thumbnails.find(".items-wrapper").width(), c = e;
            ...
            if (t) {
                var a = this.$images_wrapper.children(".image"), o = a.filter('[data-id="' + t + '"]'), r = a.index(o), l = _.clone(this.currentPic), c = {
                    num: r
                }, d = this;
                if (o.length && -1 != r) {
                    ...
                    i && l.$el && this.waitForAnimationEnd(l.$el, n), this.direction = !l.$el || !l.$el.length || l.num < c.num ? "forward" : "backward", 
                    ...
                    var h = c.num - ("forward" == this.direction ? this.PREDISPLAY_COUNT.backward : this.PREDISPLAY_COUNT.forward), u = c.num + ("forward" == this.direction ? this.PREDISPLAY_COUNT.forward : this.PREDISPLAY_COUNT.backward);
                    a.each(function(t) {
                        var e = $(this);
                        t < c.num ? d.setPicPosition(e, "prev", t + 1 === c.num) : t > c.num ? d.setPicPosition(e, "next", t - 1 === c.num) : d.setPicPosition(e, "center", t === c.num), 
        ...
        onFullscreenResize: function() {
            ...
            if ("theme_classic" == this.params.current_theme) i = e - (this.params.theme_data.thumbnails ? this.THUMBNAILS_HEIGHT : 0);
    ...
    t.widgets.text = t.classes.Widget.extend({
        ...
        stop: function() {
            return this.started = !1, t.screenshot || this.destroyed || !this.rendered || this.$el && this.$el.find("span.soundcite").each(function(t, e) {
    ...
    t.widgets.iframe = t.classes.Widget.extend({
        render: function() {
            ...
            return t ? (this.plugin = new t({
                widget: this
            }), this.$el.addClass(this.plugin.embed_type), this.clear_content ? this.contentCleared = !0 : this.drawPlugin(), 
            this) : (this.widgetIsLoaded(), this);
        },
        drawPlugin: function() {
